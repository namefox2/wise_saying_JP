...
function DictCard({entry}: {entry: DictEntry}) {
  ...
  const toggleExample = () => {
    const toValue = exampleExpanded ? 0 : 1;
  ...
  return (
    <View
      ...
      {entry.examples.length > 0 && (
        <TouchableOpacity
          ...
          <Animated.Text
            style={[
              styles.exampleArrow,
              {color: theme.accentSoft, transform: [{rotate: arrowRotation}]},
            ]}>
            ▼
          </Animated.Text>
        </TouchableOpacity>
      ...
      {exampleExpanded && entry.examples.map((ex, i) => (
        <View
          key={i}
          style={[
            styles.exampleBlock,
          ...
          !searched ? (
            <View>
              ...
              {recentSearches.length > 0 && (
                <>
                  <Text
                    style={[styles.sectionLabel, {color: theme.textMuted, marginTop: 20}]}>
                    최근 검색
                  </Text>
                  {recentSearches.map(r => (
                    <TouchableOpacity
                      ...
                      <Text style={[styles.recentIcon, {color: theme.textMuted}]}>
                        🕐
                      </Text>
                      <Text style={[styles.recentText, {color: theme.text}]}>
                        {r}
                      </Text>
                      <Text style={[styles.recentArrow, {color: theme.textMuted}]}>
                        →
                      </Text>
                    </TouchableOpacity>
                  ))}
